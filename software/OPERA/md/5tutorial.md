...
#### OPERA analysis: stagte 2 and heterogeneity analysis
```
...
```
**esmr\_thresh** and msmr_thresh are the threshold for first xQTL and other xQTLs, respectively
